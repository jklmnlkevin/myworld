 ...
 */
@Repository
public class ServiceTypeDAO extends GenericDAOHibernate<ServiceType> {
     ...
     * @return
     */
    public List<ServiceType> find(ServiceType dto, Page page) {
        StringBuilder hql = new StringBuilder();
        List<Object> paras = new ArrayList<Object>();
        hql.append("From ServiceType n where 1 = 1 ");
        if (dto.getId() != null) {
            hql.append(" and n.id = ? ");
            paras.add(dto.getId());
        }
     ...
     * @return
     */
    public ServiceType findOne(ServiceType dto) {
		Page page = new Page();
		page.setNumPerPage(1);
		page.setPageNum(1);
		
		List<ServiceType> list = this.find(dto, page);
