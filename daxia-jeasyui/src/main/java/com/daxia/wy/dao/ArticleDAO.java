 ...
 */
@Repository
public class ArticleDAO extends GenericDAOHibernate<Article> {
     ...
     * @return
     */
    public List<Article> find(ArticleDTO dto, Page page) {
        StringBuilder hql = new StringBuilder();
        List<Object> paras = new ArrayList<Object>();
        hql.append("From Article n where 1 = 1 ");
     ...
     * @return
     */
    public Article findOne(ArticleDTO dto) {
		Page page = new Page();
		page.setNumPerPage(1);
		page.setPageNum(1);
		
		List<Article> list = this.find(dto, page);
