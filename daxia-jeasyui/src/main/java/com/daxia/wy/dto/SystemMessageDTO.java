...
public class SystemMessageDTO extends SystemMessage {
     ...
     * 查出没有小区的
     */
	private boolean queryNonCommunity = false;

    public boolean isQueryNonCommunity() {
        return queryNonCommunity;
    }

    public void setQueryNonCommunity(boolean queryNonCommunity) {
        this.queryNonCommunity = queryNonCommunity;
    }
