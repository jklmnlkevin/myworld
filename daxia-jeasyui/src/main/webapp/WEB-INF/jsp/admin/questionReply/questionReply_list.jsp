...
<div class="pageHeader">
	...
	<div class="searchBar">
		<ul class="searchContent">
			<li>
				<label>咨询问题：</label>
				<input type="text" name="question" value="${dto.question}"/>	
			</li>
		</ul>
		<div class="subBar">
			<ul>
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			...
			<sec:authorize ifAnyGranted="questionReply.delete">
	...
	<table class="table" width="100%" layoutH="138" nowrapTD="false">
		<thead>
			<tr>
				...
				<th align="center" width="100">咨询问题</th>
				<th align="center" width="100">回复者</th>
