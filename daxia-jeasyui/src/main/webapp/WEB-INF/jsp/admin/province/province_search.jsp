...
<div class="pageHeader">
	...
	<input type="hidden" name="provinceType" value="${province.provinceType }"/>
	<div class="searchBar">
				用户名或手机：
				<input type="text" name="term" value="${province.term}"/>
		<div class="subBar">
			<ul>
...
<div class="pageContent">
	...
	<table class="table" width="100%" layoutH="138" nowrapTD="false">
		...
		<tbody>
			<c:forEach items="${provinces }" var="n">
			<tr target="sid_province" rel="${n.id }">
				...
				<td>${n.name}</td>
				<td>
					<a class="btnSelect" href="javascript:$.bringBack({name:'${n.provincename }', orgName:'技术部', orgNum:'1001'})" title="查找带回">选择</a>
				</td>
			</tr>
			</c:forEach>
		</tbody>
