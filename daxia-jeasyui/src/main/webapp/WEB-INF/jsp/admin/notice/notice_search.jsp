...
<div class="pageHeader">
	...
	<div class="searchBar">
				用户名或手机：
				<input type="text" name="term" value="${notice.term}"/>
		<div class="subBar">
			<ul>
		...
		<tbody>
			...
			<tr target="sid_notice" rel="${n.id }">
				<td><input name="ids" value="${n.id }" type="checkbox"></td>
					...
					<td>${n.store.name}</td>	
				<td>
					<a class="btnSelect" href="javascript:$.bringBack({name:'${n.noticename }', orgName:'技术部', orgNum:'1001'})" title="查找带回">选择</a>
				</td>
			</tr>
			</c:forEach>
		</tbody>
