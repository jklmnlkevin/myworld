...
<div class="pageHeader">
	...
	<div class="searchBar">
		<ul class="searchContent">
			<li>
				<label>id：</label>
				<input type="text" name="id" value="${keyword.id}"/>	
			</li>
			<li>
				<label>商家：</label>
				<input type="text" name="store.id" value="${keyword.store.id}" store="true" firstBlank="true"/>	
			</li>
			<li>
				<label>关键词：</label>
				<input type="text" name="keywords" value="${keyword.keywords}"/>	
			</li>
		</ul>
		<div class="subBar">
			<ul>
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			...
			<sec:authorize ifAnyGranted="keyword.delete">
	...
	<table class="table" width="100%" layoutH="138" nowrapTD="false">
		<thead>
			<tr>
				...
				<th align="center" width="100">文章</th>	
				<th align="center" width="100">商家</th>	
			</tr>
		</thead>
		<tbody>
			<c:forEach items="${keywords }" var="n">
