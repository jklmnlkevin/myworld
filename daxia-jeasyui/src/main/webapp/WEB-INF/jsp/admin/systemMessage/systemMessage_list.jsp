...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			...
			<sec:authorize ifAnyGranted="systemMessage.delete">
			...
			<li><a class="edit" href="${ctx}/admin/${module}/push?id={sid_user}&navTabId=${param.navTabId}" target="navTab" mask="true" warn="请选择要修改的记录"><span>发布</span></a></li>
	...
	<table class="table" width="100%" layoutH="138" nowrapTD="false">
		<thead>
			<tr>
				...
				<th align="center" width="100">推送时间</th>
			</tr>
		</thead>
		<tbody>
			...
			<tr target="sid_user" rel="${n.id }">
				...
				<td>
				<fmt:formatDate value="${n.pushTime}" pattern="yyyy-MM-dd HH:mm:ss"/>
				</td>
			</tr>
			</c:forEach>
		</tbody>
