...
<c:set var="module" value="serviceType"/>
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			...
			<sec:authorize ifAnyGranted="serviceType.update">
