...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			...
			<li><a class="add" href="${ctx}/admin/${module}/detail?navTabId=${param.navTabId}" target="navTab" mask="true" rel="添加回复" title="添加回复"><span>添加</span></a></li>
			</sec:authorize>
			
			<sec:authorize ifAnyGranted="reply.delete">
			...
			<li><a class="edit" href="${ctx}/admin/${module}/detail?id={sid_user}&navTabId=${param.navTabId}" target="navTab" mask="true" warn="请选择要修改的记录" rel="查看或修改回复" title="查看或修改回复"><span>查看或修改</span></a></li>
			</sec:authorize>
	...
	<table class="table" width="100%" layoutH="138" nowrapTD="false">
		...
		<tbody>
			...
			<tr target="sid_user" rel="${n.id }">
				<td><input name="ids" value="${n.id }" type="checkbox" title="id:${n.id }"></td>
				<td>${n.refrenceId}</td>
				<td>${n.content}</td>
