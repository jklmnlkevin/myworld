...
<c:set var="module" value="noticeReply"/>
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			...
			<sec:authorize ifAnyGranted="noticeReply.update">
	...
	<table class="table" width="100%" layoutH="138" nowrapTD="false">
		<thead>
			<tr>
				...
				<th align="center" width="100">通知</th>
				<th align="center" width="100">内容</th>
				<th align="center" width="100">父回复id</th>
		...
		<tbody>
			...
			<tr target="sid_user" rel="${n.id }">
				...
				<td>${n.notice.title }</td>
				<td>${n.content}</td>
				<td>${n.parentNoticeReply.content}</td>
				<td>
