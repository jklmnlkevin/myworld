...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			...
			<sec:authorize ifAnyGranted="favoriteBrand.delete">
	...
	<table class="table" width="100%" layoutH="138" nowrapTD="false">
		<thead>
			<tr>
				...
				<th align="center" width="100">钟爱的第一品牌</th>
				<th align="center" width="100">钟爱的第一产品</th>
				<th align="center" width="100">钟爱的第二品牌</th>
				<th align="center" width="100">钟爱的第二产品</th>
			</tr>
		</thead>
		<tbody>
			...
			<tr target="sid_user" rel="${n.id }">
				...
				<td>${n.firstBrand.brandName}</td>
				<td>${n.firstProduct.name}</td>
				<td>${n.secondBrand.brandName}</td>
				<td>${n.secondProduct.name}</td>
			</tr>
			</c:forEach>
		</tbody>
	</table>
