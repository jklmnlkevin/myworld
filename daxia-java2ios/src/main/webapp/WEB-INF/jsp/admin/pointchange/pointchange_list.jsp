...
<div class="pageHeader">
	...
	<div class="searchBar">
		<ul class="searchContent">
			<li>
				<label>用户名：</label>
				<input type="text" name="account.user.username" value="${dto.account.user.username}"/>	
			</li>
			<li>
				<label>积分类型：</label>
				<select name = "type">
...
<%-- 			<sec:authorize ifAnyGranted="pointchange.delete"> --%>
	...
	<table class="table" width="100%" layoutH="138" nowrapTD="false">
		<thead>
			<tr>
				...
				<th align="center" width="100">变动积分</th>
				<th align="center" width="100">期初积分</th>
				<th align="center" width="100">期末积分</th>
				<th align="center" width="100">变动时间</th>
				<th align="center" width="100">关联的用户</th>
				<th align="center" width="100">积分改变类型</th>
			</tr>
		</thead>
		<tbody>
			...
			<tr target="sid_user" rel="${n.id }">
				...
				<td>${n.account.user.username}</td>
				<td>
					<c:forEach items="${pointChangeTypes }" var="p">
						<c:if test="${p.key == n.type }">${p.value }</c:if>
					</c:forEach>
