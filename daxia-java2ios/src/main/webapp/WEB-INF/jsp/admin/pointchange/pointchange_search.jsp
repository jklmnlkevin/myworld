	...
	<table class="table" width="100%" layoutH="138" nowrapTD="false">
		<thead>
			<tr>
				...
				<th align="center" width="100">期初</th>
				<th align="center" width="100">期末</th>
				<th align="center" width="100">变动时间</th>
				<th align="center" width="100">关联的账号ID</th>
				<th align="center" width="100">积分改变类型.0-积分兑换,1-签到积分,2-消费积分</th>
				<th align="center" width="100">查找带回</th>
			</tr>
		</thead>
		<tbody>
			<c:forEach items="${list }" var="n">
			<tr target="sid_pointchange" rel="${n.id }">
