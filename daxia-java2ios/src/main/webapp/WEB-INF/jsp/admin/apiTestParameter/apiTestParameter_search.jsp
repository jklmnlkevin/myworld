...
<div class="pageHeader">
	...
	<input type="hidden" name="apiTestParameterType" value="${apiTestParameter.apiTestParameterType }"/>
	<div class="searchBar">
				用户名或手机：
				<input type="text" name="term" value="${apiTestParameter.term}"/>
		<div class="subBar">
			<ul>
...
<div class="pageContent">
	...
	<table class="table" width="100%" layoutH="138" nowrapTD="false">
		...
		<tbody>
			...
			<tr target="sid_apiTestParameter" rel="${n.id }">
				<td><input name="ids" value="${n.id }" type="checkbox"></td>
					...
					<td>${n.required}</td>
				<td>
					<a class="btnSelect" href="javascript:$.bringBack({name:'${n.apiTestParametername }', orgName:'技术部', orgNum:'1001'})" title="查找带回">选择</a>
				</td>
			</tr>
			</c:forEach>
		</tbody>
