	...
	<table class="table" width="100%" layoutH="138" nowrapTD="false">
		<thead>
			<tr>
				...
				<th align="center" width="100">问题ID</th>
				<th align="center" width="100">答案</th>
				<th align="center" width="100">问卷调查ID</th>
		...
		<tbody>
			...
			<tr target="sid_voteAnswer" rel="${n.id }">
				<td><input name="ids" value="${n.id }" type="checkbox"></td>
					<td>${n.voteQuestion}</td>
					<td>${n.answer}</td>
					<td>${n.vote}</td>
					<td>${n.user}</td>
				<td>
