...
<div class="pageHeader">
	...
	<div class="searchBar">
		<ul class="searchContent">
		 <li>
		 	<label>问卷名称:</label>
		 	<input name = "vote.voteName" value = "${dto.vote.voteName }"/>
		 </li>
		</ul>
		<div class="subBar">
			<ul>
...
<%-- 			<sec:authorize ifAnyGranted="voteAnswer.delete"> --%>
	...
	<table class="table" width="100%" layoutH="138" nowrapTD="false">
		<thead>
			<tr>
				...
				<th align="center" width="100">所属问卷</th>
				<th align="center" width="100">问题名称</th>
				<th align="center" width="100">查看结果</th>
			</tr>
		</thead>
		<tbody>
			...
			<tr target="sid_user" rel="${n.id }">
				...
				<td>${n.vote.voteName}</td>
				<td>${n.questionName}</td>
				<td>
					<a href="${ctx }/admin/voteAnswer/chart?questionId=${n.id}" target="_blank">点击查看结果</a>
				</td>
			</tr>
			</c:forEach>
		</tbody>
