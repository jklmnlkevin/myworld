...
<div class="pageHeader">
	...
	<input type="hidden" name="districtType" value="${district.districtType }"/>
	<div class="searchBar">
				用户名或手机：
				<input type="text" name="term" value="${district.term}"/>
		<div class="subBar">
			<ul>
...
<div class="pageContent">
	...
	<table class="table" width="100%" layoutH="138" nowrapTD="false">
		...
		<tbody>
			<c:forEach items="${districts }" var="n">
			<tr target="sid_district" rel="${n.id }">
				...
				<td>${n.city}</td>
				<td>
					<a class="btnSelect" href="javascript:$.bringBack({name:'${n.districtname }', orgName:'技术部', orgNum:'1001'})" title="查找带回">选择</a>
				</td>
			</tr>
			</c:forEach>
		</tbody>
