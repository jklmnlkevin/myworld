...
<div class="pageHeader">
	<form onsubmit="return navTabSearch(this);" action="${ctx }/admin/${module}/list" method="post">
	<div class="searchBar">
		<div class="subBar">
			<ul>
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			...
			<sec:authorize ifAnyGranted="用户模块.用户管理.角色设置">
			<li><a class="edit" href="${ctx}/admin/${module}/detailRole?id={sid_user}&navTabId=${param.navTabId}" target="navTab" mask="true" warn="请选择要修改的记录"><span>角色设置</span></a></li>
			</sec:authorize>
