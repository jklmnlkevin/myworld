...
<div class="pageHeader">
	...
	<div class="searchBar">
		<ul class="searchContent">
			<li>
				<label>key：</label>
				<input type="text" name="key" value="${systemConfig.key}"/>
			</li>
		</ul>
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			...
			<sec:authorize ifAnyGranted="system.systemConfig.delete">
	...
	<table class="table" width="100%" layoutH="138" nowrapTD="false" >
		<thead>
			<tr>
				...
				<th align="left" width="100">key</th>
				<th align="left" width="100">value</th>
				<th align="left" width="100">说明</th>

			</tr>
		</thead>
		<tbody>
			<c:forEach items="${systemConfigs }" var="n">
