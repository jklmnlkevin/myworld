...
<div class="pageContent">
	<form method="post" action="${ctx }/admin/${module }/doResetPassword?id=${manager.id}&navTabId=${param.navTabId}" class="pageForm required-validate" onsubmit="return validateCallback(this,navTabAjaxDone);">
		<div class="pageFormContent" layoutH="56">
			<p>
				<label>用户名:</label>
				<input type="hidden" name="id" value="${manager.id}" size="30" />
				${manager.username }
			</p>
			<p>
				<label></label>
				<input type="hidden" value="${manager.id}" size="30" />
