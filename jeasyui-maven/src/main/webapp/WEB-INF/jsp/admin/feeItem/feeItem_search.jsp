	...
	<table class="table" width="100%" layoutH="138" nowrapTD="false">
		<thead>
			<tr>
				...
				<th align="center" width="100">缴费项目名称</th>
		...
		<tbody>
			...
			<tr target="sid_feeItem" rel="${n.id }">
				<td><input name="ids" value="${n.id }" type="checkbox"></td>
					...
					<%-- <td>${n.createTime}</td> --%>
				<td>
					<a class="btnSelect" href="javascript:$.bringBack({name:'${typeName }', id:'${n.id }', orgNum:'1001'})" title="查找带回">选择</a>
				</td>
			</tr>
			</c:forEach>
		</tbody>
