...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			...
			<sec:authorize ifAnyGranted="communityAddApply.delete">
	...
	<table class="table" width="100%" layoutH="138" nowrapTD="false">
		<thead>
			<tr>
				...
				<th align="center" width="100">小区名称</th>
				<th align="center" width="100">小区地址</th>
				<th align="center" width="100">地区</th>
				<th align="center" width="100">0，新增， 1，同意，2，拒绝</th>
			</tr>
		</thead>
		<tbody>
