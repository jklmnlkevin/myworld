...
<div class="pageHeader">
	...
	<div class="searchBar">
		<ul class="searchContent">
			...
			<li>
				<label>楼栋号：</label>
				<input type="text" name="building.name" value="${dto.building.name}"/>	
			</li>
		</ul>
		<div class="subBar">
			<ul>
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			...
			<sec:authorize ifAnyGranted="doorplate.delete">
	...
	<table class="table" width="100%" layoutH="138" nowrapTD="false">
		<thead>
			<tr>
				...
				<th align="center" width="100">楼栋号</th>
				<th align="center" width="100">房屋面积（平米）</th>
			</tr>
		</thead>
		<tbody>
