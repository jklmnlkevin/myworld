...
<div class="pageHeader">
	...
	<input type="hidden" name="natureType" value="${nature.natureType }"/>
	<div class="searchBar">
				用户名或手机：
				<input type="text" name="term" value="${nature.term}"/>
		<div class="subBar">
			<ul>
	...
	<table class="table" width="100%" layoutH="138" nowrapTD="false">
		<thead>
			<tr>
				...
				<th align="center" width="100">属性名称</th>
				<th align="center" width="100">查找带回</th>
			</tr>
		</thead>
		<tbody>
			<c:forEach items="${natures }" var="n">
			<tr target="sid_nature" rel="${n.id }">
				<td><input name="ids" value="${n.id }" type="checkbox"></td>
					<td>${n.name}</td>
				<td>
					<a class="btnSelect" href="javascript:$.bringBack({name:'${n.naturename }', orgName:'技术部', orgNum:'1001'})" title="查找带回">选择</a>
				</td>
			</tr>
			</c:forEach>
		</tbody>
