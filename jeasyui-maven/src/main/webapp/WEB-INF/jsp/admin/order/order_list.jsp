...
<div class="pageHeader">
	...
	<div class="searchBar">
		<ul class="searchContent">
			<li>
				<label>订单号：</label>
				<input type="text" name="orderNo" value="${dto.orderNo}"/>	
			</li>
			<li>
				<label>用户：</label>
...
<div class="pageContent">
	<div class="panelBar">
		<ul class="toolBar">
			...
			<sec:authorize ifAnyGranted="order.delete">
	...
	<table class="table" width="100%" layoutH="138" nowrapTD="false">
		<thead>
			<tr>
				...
				<th align="center" width="100">订单号</th>
				...
				<th align="center" width="100">订单状态</th>
			</tr>
		</thead>
		<tbody>
